...
def get_adv_content(user: Optional[dict]) -> Tuple[str, types.InlineKeyboardMarkup]:
    ...
    text = (
        ...
        "<blockquote expandable>🔹 Tayyor ijodiy post <i>(Matn + Rasm/Video)</i></blockquote>\n"
        "<blockquote expandable>🔹 To'g'ri sozlangan yashirin muhrlar <i>(Linklar)</i></blockquote>\n"
        "<blockquote expandable>🔹 Klanlararo kelishilgan vaqt va reja</blockquote>\n"
        "✨ <b>Nima uchun aynan biz?</b>\n"
        "<blockquote expandable>✅ Doimiy faol va tirik foydalanuvchilar jamoasi</blockquote>\n"
        "<blockquote expandable>✅ Hamyonbop oltinlar <i>(Narxlar)</i></blockquote>\n"
        "<blockquote expandable>✅ Joylashtirish  tezligida ⚡️</blockquote>\n\n"
        "═════════ ⛩ ═════════\n"
